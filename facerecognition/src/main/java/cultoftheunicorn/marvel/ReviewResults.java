...
public class ReviewResults extends AppCompatActivity implements ReviewListAdapter.ClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Validez votre profil");
        }
    ...
    public void commit() {
        ...
        if(commitList.size() == 1) {
            ...
            // Partie a modifier pour la requete firebase
...
//            myRef.child(key).setValue(at);
            ...
            Toast.makeText(getApplicationContext(), "Connectez l'application à Firebase", Toast.LENGTH_LONG).show();
//            finish();
...
//            System.out.println(sb.toString());
            ...
            Toast.makeText(getApplicationContext(), "Selectionnez votre profil", Toast.LENGTH_SHORT).show();
        }
    }
}
